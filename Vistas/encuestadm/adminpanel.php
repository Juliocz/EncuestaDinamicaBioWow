...
V::$viewData->v_body=function(){ ?>
  ...
  <style>
    :root {
  --page-header-bgColor: var(--theme1-bg);
...
<header class="page-header">
  <nav>
    <a href="#0" aria-label="forecastr logo" class="logo" style="display:flex;justify-content: center;">
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="<?php  echo V::$ruta_base.'/adm/panel?idun='.V::$data->negocio_admin->idun; ?>">
          <svg>
            <use xlink:href="#pages"></use>
          </svg>
          <span style="font-weight: bold;">IR A ENCUESTAS</span>
        </a>
      </li>
      ...
      <?php  foreach(V::$data->negocios as $neg){ ?>
      <li id="<?php  echo 'negog_'.$neg->idun;?>">
        <a href="<?php  echo V::$ruta_base.'/adm/panel?idun='.$neg->idun; ?>">
          <svg>
            <use xlink:href="<?php  echo V::$ruta_base.'/adm/panel?idun='.$neg->idun; ?>"></use>
          </svg>
          <span style="font-weight: bold;"><?php  echo $neg->nombre; ?></span>
        </a>
      </li>
      <?php  } ?>
...
<section class="page-content">
  <section class="search-and-user">
    ...
    <div class="admin-profile">
      <span class="btn btn-secondary dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">HOLA , <?php  echo V::$data->nombre_usuario; ?> :) </span>
    ...
    <li><a class="dropdown-item" href="<?php echo V::$ruta_base.'adm/logout';?>">Cerrar Sesion</a></li>
  </ul>
    </div>
  </section>
  <div>
  ...
  <footer class="page-footer">
    <span>Developed by Julio</span>
    <a href="https://DevJulioCZ.com/" target="_blank">
    <!-- <a href="https://georgemartsoukos.com/" target="_blank"> -->
      <!-- <img width="24" height="24" src="https://assets.codepen.io/162656/george-martsoukos-small-logo.svg" alt="George Martsoukos logo"> -->
      <img width="24" height="24" src="<?php echo V::$ruta_base.'res/Logo JulioCesarLL.png'?>" alt="Julio Cesar Llampa Gutierrez logo">
    </a>
  </footer>
</section>
